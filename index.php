...
if (isset($_GET["add_to_cart"])) {
    $idArticle = (int)$_GET["add_to_cart"];
    {
        if  (!array_key_exists('product-' . $idArticle, $_SESSION)) {
            $_SESSION['product-' . $idArticle] = 1;
        } elseif (array_key_exists('product-' . $idArticle, $_SESSION)) {
            $_SESSION['product-' . $idArticle] += 1;
        }
    }
}
